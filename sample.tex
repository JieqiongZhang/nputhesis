%% UTF-8
\documentclass[twoside,UTF8,phd,multibib]{nputhesis}
...
%% 使用 multibib 选项, 可以用如下方式添加研究成果
%% TODO 作者名自动加粗显示
%% \work[<bibstyle>][<bib-file>][<bib-key-list>]
%% e.g.
%%     \Work[nputhesis]{ref}{zhao2017, qian2018, sun2019}
\Work[nputhesis]{ref}{Zhang3040, Zhang3041}
%% 不使用 multibib 选项时, \Work 仅用于生成标题
% \Work
